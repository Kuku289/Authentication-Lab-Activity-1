                    ...
                    <div class="card-body">
                        <form method="POST" action="" class="mt-4" id="register-form">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control animate__animated animate__fadeInUp" id="country" name="country">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control animate__animated animate__fadeInUp" id="city" name="city" placeholder="Enter your city">
                            </div>
                            <div class="mb-4">
